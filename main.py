...
def convert():
    ...
    # 🚀 API BACKEND (No IP Ban, No Crash)
    ...
    # Map format selection to API Logic
    # Note: 8SVX/AMR are removed because Cloud APIs usually don't support them.
    audio_format = fmt
    if fmt == 'best':
        audio_format = None
